...
const API_PAYMENT_HOST_PREFIX = process.env.REACT_APP_API_PAYMENTS;
const STRIPE_API_KEY = process.env.REACT_APP_STRIPE_KEY;

logger({ API_HOST_PREFIX, API_NODE_HOST_PREFIX });

export { onGlobalError, onGlobalSuccess, API_HOST_PREFIX, API_NODE_HOST_PREFIX, API_PAYMENT_HOST_PREFIX, STRIPE_API_KEY };
