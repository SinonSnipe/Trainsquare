...
const Venues = () => {
    ...
    const mapVenue = (aVenue) => {
        return <VenueCard venue={aVenue} key={aVenue.id} onDeleteClicked={onDeleteRequested} editHandle={editHandle} bookVenueHandle={bookVenueHandle}/>;
    };
    ...
    const bookVenueHandle = (aVenue) => {
        _logger('bookVenueHandle running', aVenue);
        const stateForTransport = { aVenue};
        navigate(`/venues/book/${aVenue.id}`, { state: stateForTransport});
    };
