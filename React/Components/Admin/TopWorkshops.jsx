                ...
                <Table hover responsive className="mb-0">
                    <tbody>
                        {(workshops || []).map((workshop, i) => {
                            const dateStartConvert = new Date(workshop.dateCreated).toDateString();
                            ...
                            return (
                                <tr key={i}>
                                    ...
                                    <td>
                                        <h5 className="font-14 my-1 fw-normal">{dateStartConvert}</h5>
                                    ...
                                    <td>
                                        <h5 className="font-14 my-1 fw-normal">{workshop.numberOfSessions}</h5>
                                        <span className="text-muted font-13">Sessions</span>
                                    </td>
                                    <td>
                                        <h5 className="font-14 my-1 fw-normal">{workshop.workShopStatus}</h5>
                                        <span className="text-muted font-13">Status</span>
                                    </td>
                                    <td>
                                        <h5 className="font-14 my-1 fw-normal">{workshop.host.firstName}</h5>
