...
const _logger = debug.extend('TotalSalesApex');

const TotalSalesApex = () => {
    const apexDonutOpts = {
        chart: {
            height: 340,
            type: 'donut',
        ...
        <Card>
            <Card.Body>
                ...
                <div className="chart-widget-list">
                    <p>
                        <i className="mdi mdi-square text-primary"></i> Workshops
                        <span className="float-end">$300.56</span>
                    </p>
                    <p>
                        <i className="mdi mdi-square text-danger"></i> Products
